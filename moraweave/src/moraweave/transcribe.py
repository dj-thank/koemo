...
from .longform import LongFormConfig, transcribe_longform


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m moraweave.transcribe",
        description="Complete Japanese transcription with evidence fusion and selective re-listening.",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    document = transcribe_longform(args.audio, output_dir=args.output_dir, config=config)
